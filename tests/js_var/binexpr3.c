...
int main(void) {
    ...
    log(js_var_plus(js_var_from_int16_t(num), static_array1->data[1]));
    ...
    log(js_var_plus(js_var_from_int16_t(num), DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED))));
    ...
    log(js_var_plus(DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED)), js_var_from_int16_t(num)));
    log(js_var_plus(js_var_from_int16_t(num), v_null));
    log(js_var_plus(v_undefined, js_var_from_int16_t(num)));
    log(js_var_plus(js_var_from_int16_t(num), v_nan));
    log(js_var_plus(v_num, js_var_from_int16_t(num)));
    log(js_var_plus(js_var_from_int16_t(num), v_str));
    log(js_var_plus(v_str_num, js_var_from_int16_t(num)));
    log(js_var_plus(js_var_from_int16_t(num), v_bool1));
    log(js_var_plus(v_bool2, js_var_from_int16_t(num)));
    log(js_var_plus(js_var_from_int16_t(num), v_arr1));
    log(js_var_plus(v_arr2, js_var_from_int16_t(num)));
    log(js_var_plus(js_var_from_int16_t(11 + num), v_arr3));
    log(js_var_plus(js_var_from_int16_t(num), v_dict1));
    log(js_var_plus(js_var_from_int16_t(num), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_int16_t(num)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_int16_t(num)));
    ...
    log(js_var_plus(static_array1->data[1], js_var_from_str(str)));
    ...
    log(js_var_plus(DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED)), js_var_from_str(str)));
    ...
    log(js_var_plus(js_var_from_str(str), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_str(str)));
    log(js_var_plus(js_var_from_str(str), v_undefined));
    log(js_var_plus(v_nan, js_var_from_str(str)));
    log(js_var_plus(js_var_from_str(str), v_num));
    log(js_var_plus(v_str, js_var_from_str(str)));
    log(js_var_plus(js_var_from_str(str), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_str(str)));
    log(js_var_plus(js_var_from_str(str), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_str(str)));
    log(js_var_plus(js_var_from_str(str), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_str(str)));
    log(js_var_plus(js_var_from_str(str), v_dict1));
    log(js_var_plus(js_var_from_str(str), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_str(str)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_str(str)));
    ...
    log(js_var_plus(js_var_from_str(str_num), static_array1->data[1]));
    ...
    log(js_var_plus(js_var_from_str(str_num), DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED))));
    ...
    log(js_var_plus(DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED)), js_var_from_str(str_num)));
    log(js_var_plus(js_var_from_str(str_num), v_null));
    log(js_var_plus(v_undefined, js_var_from_str(str_num)));
    log(js_var_plus(js_var_from_str(str_num), v_nan));
    log(js_var_plus(v_num, js_var_from_str(str_num)));
    log(js_var_plus(js_var_from_str(str_num), v_str));
    log(js_var_plus(v_str_num, js_var_from_str(str_num)));
    log(js_var_plus(js_var_from_str(str_num), v_bool1));
    log(js_var_plus(v_bool2, js_var_from_str(str_num)));
    log(js_var_plus(js_var_from_str(str_num), v_arr1));
    log(js_var_plus(v_arr2, js_var_from_str(str_num)));
    ...
    log(js_var_plus(js_var_from_str(tmp_result_35), v_arr3));
    log(js_var_plus(js_var_from_str(str_num), v_dict1));
    log(js_var_plus(js_var_from_str(str_num), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_str(str_num)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_int16_t(num)));
    ...
    log(js_var_plus(static_array1->data[1], js_var_from_uint8_t(bool1)));
    ...
    log(js_var_plus(DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED)), js_var_from_uint8_t(bool1)));
    ...
    log(js_var_plus(js_var_from_uint8_t(bool1), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_uint8_t(bool1)));
    log(js_var_plus(js_var_from_uint8_t(bool1), v_undefined));
    log(js_var_plus(v_nan, js_var_from_uint8_t(bool1)));
    log(js_var_plus(js_var_from_uint8_t(bool1), v_num));
    log(js_var_plus(v_str, js_var_from_uint8_t(bool1)));
    log(js_var_plus(js_var_from_uint8_t(bool1), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_uint8_t(bool1)));
    log(js_var_plus(js_var_from_uint8_t(bool1), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_uint8_t(bool1)));
    log(js_var_plus(js_var_from_uint8_t(bool1), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_uint8_t(bool1)));
    log(js_var_plus(js_var_from_uint8_t(bool1), v_dict1));
    log(js_var_plus(js_var_from_uint8_t(bool1), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_uint8_t(bool1)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_uint8_t(bool1)));
    ...
    log(js_var_plus(static_array1->data[1], js_var_from_uint8_t(bool2)));
    ...
    log(js_var_plus(DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED)), js_var_from_uint8_t(bool2)));
    ...
    log(js_var_plus(js_var_from_uint8_t(bool2), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_uint8_t(bool2)));
    log(js_var_plus(js_var_from_uint8_t(bool2), v_undefined));
    log(js_var_plus(v_nan, js_var_from_uint8_t(bool2)));
    log(js_var_plus(js_var_from_uint8_t(bool2), v_num));
    log(js_var_plus(v_str, js_var_from_uint8_t(bool2)));
    log(js_var_plus(js_var_from_uint8_t(bool2), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_uint8_t(bool2)));
    log(js_var_plus(js_var_from_uint8_t(bool2), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_uint8_t(bool2)));
    log(js_var_plus(js_var_from_uint8_t(bool2), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_uint8_t(bool2)));
    log(js_var_plus(js_var_from_uint8_t(bool2), v_dict1));
    log(js_var_plus(js_var_from_uint8_t(bool2), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_uint8_t(bool2)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_uint8_t(bool2)));
    ...
    log(js_var_plus(static_array1->data[1], js_var_from_array(static_array1)));
    ...
    log(js_var_plus(DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED)), js_var_from_array(static_array1)));
    ...
    log(js_var_plus(js_var_from_array(static_array1), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_array(static_array1)));
    log(js_var_plus(js_var_from_array(static_array1), v_undefined));
    log(js_var_plus(v_nan, js_var_from_array(static_array1)));
    log(js_var_plus(js_var_from_array(static_array1), v_num));
    log(js_var_plus(v_str, js_var_from_array(static_array1)));
    log(js_var_plus(js_var_from_array(static_array1), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_array(static_array1)));
    log(js_var_plus(js_var_from_array(static_array1), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_array(static_array1)));
    log(js_var_plus(js_var_from_array(static_array1), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_array(static_array1)));
    log(js_var_plus(js_var_from_array(static_array1), v_dict1));
    log(js_var_plus(js_var_from_array(static_array1), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_array(static_array1)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_array(static_array1)));
    ...
    log(js_var_plus(DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED)), js_var_from_array(static_array2)));
    ...
    log(js_var_plus(js_var_from_array(static_array2), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_array(static_array2)));
    log(js_var_plus(js_var_from_array(static_array2), v_undefined));
    log(js_var_plus(v_nan, js_var_from_array(static_array2)));
    log(js_var_plus(js_var_from_array(static_array2), v_num));
    log(js_var_plus(v_str, js_var_from_array(static_array2)));
    log(js_var_plus(js_var_from_array(static_array2), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_array(static_array2)));
    log(js_var_plus(js_var_from_array(static_array2), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_array(static_array2)));
    log(js_var_plus(js_var_from_array(static_array2), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_array(static_array2)));
    log(js_var_plus(js_var_from_array(static_array2), v_dict1));
    log(js_var_plus(js_var_from_array(static_array2), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_array(static_array2)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_array(static_array2)));
    ...
    log(js_var_plus(DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED)), js_var_from_array(dynamic_array1)));
    ...
    log(js_var_plus(js_var_from_array(dynamic_array1), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_array(dynamic_array1)));
    log(js_var_plus(js_var_from_array(dynamic_array1), v_undefined));
    log(js_var_plus(v_nan, js_var_from_array(dynamic_array1)));
    log(js_var_plus(js_var_from_array(dynamic_array1), v_num));
    log(js_var_plus(v_str, js_var_from_array(dynamic_array1)));
    log(js_var_plus(js_var_from_array(dynamic_array1), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_array(dynamic_array1)));
    log(js_var_plus(js_var_from_array(dynamic_array1), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_array(dynamic_array1)));
    log(js_var_plus(js_var_from_array(dynamic_array1), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_array(dynamic_array1)));
    log(js_var_plus(js_var_from_array(dynamic_array1), v_dict1));
    log(js_var_plus(js_var_from_array(dynamic_array1), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_array(dynamic_array1)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_array(dynamic_array1)));
    ...
    log(js_var_plus(DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED)), js_var_from_array(dynamic_array2)));
    ...
    log(js_var_plus(js_var_from_array(dynamic_array2), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_array(dynamic_array2)));
    log(js_var_plus(js_var_from_array(dynamic_array2), v_undefined));
    log(js_var_plus(v_nan, js_var_from_array(dynamic_array2)));
    log(js_var_plus(js_var_from_array(dynamic_array2), v_num));
    log(js_var_plus(v_str, js_var_from_array(dynamic_array2)));
    log(js_var_plus(js_var_from_array(dynamic_array2), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_array(dynamic_array2)));
    log(js_var_plus(js_var_from_array(dynamic_array2), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_array(dynamic_array2)));
    log(js_var_plus(js_var_from_array(dynamic_array2), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_array(dynamic_array2)));
    log(js_var_plus(js_var_from_array(dynamic_array2), v_dict1));
    log(js_var_plus(js_var_from_array(dynamic_array2), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_array(dynamic_array2)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_array(dynamic_array2)));
    ...
    log(js_var_plus(js_var_from_array(dynamic_array3), DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED))));
    ...
    log(js_var_plus(DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED)), js_var_from_array(dynamic_array3)));
    log(js_var_plus(js_var_from_array(dynamic_array3), v_null));
    log(js_var_plus(v_undefined, js_var_from_array(dynamic_array3)));
    log(js_var_plus(js_var_from_array(dynamic_array3), v_nan));
    log(js_var_plus(v_num, js_var_from_array(dynamic_array3)));
    log(js_var_plus(js_var_from_array(dynamic_array3), v_str));
    log(js_var_plus(v_str_num, js_var_from_array(dynamic_array3)));
    log(js_var_plus(js_var_from_array(dynamic_array3), v_bool1));
    log(js_var_plus(v_bool2, js_var_from_array(dynamic_array3)));
    log(js_var_plus(js_var_from_array(dynamic_array3), v_arr1));
    log(js_var_plus(v_arr2, js_var_from_array(dynamic_array3)));
    ...
    log(js_var_plus(js_var_from_array(dynamic_array3), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_array(dynamic_array3)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_array(dynamic_array3)));
    ...
    log(js_var_plus(js_var_from_dict(obj), DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED))));
    ...
    log(js_var_plus(DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED)), js_var_from_dict(obj)));
    log(js_var_plus(js_var_from_dict(obj), v_null));
    log(js_var_plus(v_undefined, js_var_from_dict(obj)));
    log(js_var_plus(js_var_from_dict(obj), v_nan));
    log(js_var_plus(v_num, js_var_from_dict(obj)));
    log(js_var_plus(js_var_from_dict(obj), v_str));
    log(js_var_plus(v_str_num, js_var_from_dict(obj)));
    log(js_var_plus(js_var_from_dict(obj), v_bool1));
    log(js_var_plus(v_bool2, js_var_from_dict(obj)));
    log(js_var_plus(js_var_from_dict(obj), v_arr1));
    log(js_var_plus(v_arr2, js_var_from_dict(obj)));
    ...
    log(js_var_plus(js_var_from_str(tmp_result_88), v_arr3));
    log(js_var_plus(js_var_from_dict(obj), v_dict1));
    log(js_var_plus(js_var_from_dict(obj), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_dict(obj)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_dict(obj)));
    ...
    log(js_var_plus(js_var_from_dict(dict), DICT_GET(dict, "test3", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_null, js_var_from_dict(dict)));
    log(js_var_plus(js_var_from_dict(dict), v_undefined));
    log(js_var_plus(v_nan, js_var_from_dict(dict)));
    log(js_var_plus(js_var_from_dict(dict), v_num));
    log(js_var_plus(v_str, js_var_from_dict(dict)));
    log(js_var_plus(js_var_from_dict(dict), v_str_num));
    log(js_var_plus(v_bool1, js_var_from_dict(dict)));
    log(js_var_plus(js_var_from_dict(dict), v_bool2));
    log(js_var_plus(v_arr1, js_var_from_dict(dict)));
    log(js_var_plus(js_var_from_dict(dict), v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), js_var_from_dict(dict)));
    log(js_var_plus(js_var_from_dict(dict), v_dict1));
    log(js_var_plus(js_var_from_dict(dict), js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, js_var_from_dict(dict)));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), js_var_from_dict(dict)));
    log(js_var_plus(js_var_from_int16_t(9), v_null));
    log(js_var_plus(v_null, v_null));
    log(js_var_plus(v_null, v_undefined));
    log(js_var_plus(v_nan, v_null));
    log(js_var_plus(v_null, v_num));
    log(js_var_plus(v_str, v_null));
    log(js_var_plus(v_null, v_str_num));
    log(js_var_plus(v_bool1, v_null));
    log(js_var_plus(v_null, v_bool2));
    log(js_var_plus(v_arr1, v_null));
    log(js_var_plus(v_null, v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), v_null));
    log(js_var_plus(v_null, v_dict1));
    log(js_var_plus(v_null, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_null));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_null));
    log(js_var_plus(v_undefined, js_var_from_int16_t(9)));
    log(js_var_plus(v_undefined, v_undefined));
    log(js_var_plus(v_undefined, DICT_GET(obj, "a", js_var_from(JS_VAR_UNDEFINED))));
    log(js_var_plus(v_undefined, v_nan));
    log(js_var_plus(v_num, v_undefined));
    log(js_var_plus(v_undefined, v_str));
    log(js_var_plus(v_str_num, v_undefined));
    log(js_var_plus(v_undefined, v_bool1));
    log(js_var_plus(v_bool2, v_undefined));
    log(js_var_plus(v_undefined, v_arr1));
    log(js_var_plus(v_arr2, v_undefined));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_undefined), v_arr3));
    log(js_var_plus(v_undefined, v_dict1));
    log(js_var_plus(v_undefined, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_undefined));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_undefined));
    log(js_var_plus(v_nan, js_var_from_int16_t(9)));
    log(js_var_plus(v_nan, v_nan));
    log(js_var_plus(v_num, v_nan));
    log(js_var_plus(v_nan, v_str));
    log(js_var_plus(v_str_num, v_nan));
    log(js_var_plus(v_nan, v_bool1));
    log(js_var_plus(v_bool2, v_nan));
    log(js_var_plus(v_nan, v_arr1));
    log(js_var_plus(v_arr2, v_nan));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_nan), v_arr3));
    log(js_var_plus(v_nan, v_dict1));
    log(js_var_plus(v_nan, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_nan));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_nan));
    log(js_var_plus(js_var_from_int16_t(9), v_num));
    log(js_var_plus(v_num, v_num));
    log(js_var_plus(v_str, v_num));
    log(js_var_plus(v_num, v_str_num));
    log(js_var_plus(v_bool1, v_num));
    log(js_var_plus(v_num, v_bool2));
    log(js_var_plus(v_arr1, v_num));
    log(js_var_plus(v_num, v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), v_num));
    log(js_var_plus(v_num, v_dict1));
    log(js_var_plus(v_num, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_num));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_num));
    log(js_var_plus(js_var_from_int16_t(9), v_str));
    log(js_var_plus(v_str, v_str));
    log(js_var_plus(v_str, v_str_num));
    log(js_var_plus(v_bool1, v_str));
    log(js_var_plus(v_str, v_bool2));
    log(js_var_plus(v_arr1, v_str));
    log(js_var_plus(v_str, v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), v_str));
    log(js_var_plus(v_str, v_dict1));
    log(js_var_plus(v_str, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_str));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_str));
    log(js_var_plus(js_var_from_int16_t(9), v_str_num));
    log(js_var_plus(v_str_num, v_str_num));
    log(js_var_plus(v_bool1, v_str_num));
    log(js_var_plus(v_str_num, v_bool2));
    log(js_var_plus(v_arr1, v_str_num));
    log(js_var_plus(v_str_num, v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), v_str_num));
    log(js_var_plus(v_str_num, v_dict1));
    log(js_var_plus(v_str_num, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_str_num));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_str_num));
    log(js_var_plus(js_var_from_int16_t(9), v_bool1));
    log(js_var_plus(v_bool1, v_bool1));
    log(js_var_plus(v_bool1, v_bool2));
    log(js_var_plus(v_arr1, v_bool1));
    log(js_var_plus(v_bool1, v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), v_bool1));
    log(js_var_plus(v_bool1, v_dict1));
    log(js_var_plus(v_bool1, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_bool1));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_bool1));
    log(js_var_plus(js_var_from_int16_t(9), v_arr1));
    log(js_var_plus(v_arr1, v_arr1));
    log(js_var_plus(v_arr1, v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), v_arr1));
    log(js_var_plus(v_arr1, v_dict1));
    log(js_var_plus(v_arr1, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_arr1));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_arr1));
    log(js_var_plus(js_var_from_int16_t(9), v_arr2));
    log(js_var_plus(v_arr2, v_arr2));
    log(js_var_plus(js_var_plus(js_var_from_int16_t(11), v_arr3), v_arr2));
    log(js_var_plus(v_arr2, v_dict1));
    log(js_var_plus(v_arr2, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_arr2));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_arr2));
    log(js_var_plus(v_dict1, js_var_from_int16_t(9)));
    log(js_var_plus(v_dict1, v_dict1));
    log(js_var_plus(v_dict1, js_var_get(v_dict1, js_var_from_str("a"))));
    log(js_var_plus(v_dict2, v_dict1));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_dict1));
    log(js_var_plus(v_dict2, js_var_from_int16_t(9)));
    log(js_var_plus(v_dict2, v_dict2));
    log(js_var_plus(js_var_get(v_dict2, js_var_from_str("test3")), v_dict2));
