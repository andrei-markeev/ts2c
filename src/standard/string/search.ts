...
import { StringVarType, NumberVarType, RegexVarType, CType } from '../../types/ctypes';
...
@StandardCallResolver('search')
class StringSearchResolver implements ITypeExtensionResolver {
