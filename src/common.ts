import { HeaderFlags } from "./program";
...
{/if}
{#if headerFlags.array || headerFlags.dict || headerFlags.js_var_dict || headerFlags.js_var_plus || headerFlags.try_catch || headerFlags.js_var_get || headerFlags.js_var_log}
...
{#if headerFlags.dict || headerFlags.gc_dict}
...
{#if headerFlags.array_string_t || headerFlags.js_var_dict || headerFlags.js_var_dict_inc || headerFlags.js_var_get || headerFlags.try_catch || headerFlags.js_var_log}
...
{#if headerFlags.array_pointer_t || headerFlags.gc_main || headerFlags.js_var_plus || headerFlags.js_var_log}
...
{#if headerFlags.js_var_dict || headerFlags.js_var_dict_inc || headerFlags.js_var_log}
...
export class CCommon {
    constructor(public headerFlags: HeaderFlags, public emitIncludeGuard = false) { };
}