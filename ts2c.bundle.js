...
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
...
var MemoryManager = /** @class */ (function () {
            ...
            for (var nodes_1 = __values(nodes), nodes_1_1 = nodes_1.next(); !nodes_1_1.done; nodes_1_1 = nodes_1.next()) {
                ...
                switch (node.kind) {
                    ...
                    case ts.SyntaxKind.BinaryExpression:
                        {
                            ...
                            if ((0, utils_1.isPlusOp)(binExpr.operatorToken.kind)) {
                                if (leftType == ctypes_1.UniversalVarType || rightType == ctypes_1.UniversalVarType)
                                    this.needsGCMain = true;
                                else {
                                    var n = binExpr;
                                    while (ts.isBinaryExpression(n.parent) && (0, utils_1.isPlusOp)(n.parent.operatorToken.kind))
                                        n = n.parent;
                                    var isInConsoleLog = ts.isCallExpression(n.parent) && n.parent.expression.getText() == "console.log";
                                    if (!isInConsoleLog && ((0, utils_1.toPrimitive)(leftType) == ctypes_1.StringVarType || (0, utils_1.toPrimitive)(rightType) == ctypes_1.StringVarType))
                    ...
                    case ts.SyntaxKind.FunctionDeclaration:
                        {
                            var type = this.typeHelper.getCType(node);
                            var parentFunc = (0, utils_1.findParentFunction)(node.parent);
    ...
    MemoryManager.prototype.getGCVariablesForScope = function (node) {
        var parentDecl = (0, utils_1.findParentFunction)(node);
    ...
    MemoryManager.prototype.getDestructorsForScope = function (node) {
        ...
        if (this.scopes[scopeId]) {
            try {
                ...
                for (var _b = __values(this.scopes[scopeId].filter(function (v) { return v.simple && v.used; })), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var simpleVarScopeInfo = _c.value;
    ...
    MemoryManager.prototype.scheduleNodeDisposal = function (heapNode, options) {
        ...
        var topScopeNode = (0, utils_1.findParentFunction)(heapNode);
        ...
        while (queue.length > 0) {
            var _c = queue.shift(), node = _c.node, nodeFunc = _c.nodeFunc;
            ...
            var returned = false;
            try {
                for (var refs_1 = (e_3 = void 0, __values(refs)), refs_1_1 = refs_1.next(); !refs_1_1.done; refs_1_1 = refs_1.next()) {
                    var ref = refs_1_1.value;
                    visited[ref.pos + "_" + ref.end] = true;
                    var parentNode = (0, utils_1.findParentFunction)((0, utils_1.isFunction)(ref) ? ref.parent : ref);
                    if (!parentNode)
                        topScope = "main";
                    ...
                    if (ref.parent && ts.isPropertyAccessExpression(ref.parent) && ref.parent.name === ref) {
                        ...
                        if (type_1 instanceof ctypes_1.StructType) {
                    ...
                    if (ref.parent && ts.isElementAccessExpression(ref.parent) && ref.parent.argumentExpression === ref) {
                        var type_2 = this.typeHelper.getCType(ref.parent.expression);
                        if (type_2 instanceof ctypes_1.DictType) {
                    ...
                    if ((0, utils_1.isEqualsExpression)(ref.parent) && ref.parent.left.getText() == heapNode.getText()) {
                        console.log(heapNode.getText() + " -> Detected assignment: " + ref.parent.getText() + ".");
                        isSimple = false;
                    }
                    if (ts.isBinaryExpression(ref) && (0, utils_1.isCompoundAssignment)(ref.operatorToken)) {
                        console.log(ref.getText() + " -> is a compound assignment to variable " + ref.left.getText());
                        queue.push({ node: ref.left, nodeFunc: nodeFunc });
                    }
                    if (ref.parent && ts.isPropertyAssignment(ref.parent) && ref === ref.parent.initializer) {
                        ...
                        queue.push({ node: ref.parent.name, nodeFunc: nodeFunc });
                    ...
                    if (ref.parent && ref.parent.kind == ts.SyntaxKind.CallExpression) {
                        ...
                        if (ts.isIdentifier(call.expression) && call.expression === ref) {
                            ...
                            if (topScope !== "main") {
                                var funcNode = (0, utils_1.findParentFunction)(call);
        ...
        if (!isTemp)
        ...
        else if ((0, utils_1.isFunction)(heapNode)) {
            ...
            var name = heapNode.name ? heapNode.name.text + "_" + suffix : maybePropertyName;
            varName = this.symbolsHelper.addTemp((0, utils_1.findParentSourceFile)(heapNode), name);
        }
        else
        ...
        try {
            for (var foundScopes_1 = __values(foundScopes), foundScopes_1_1 = foundScopes_1.next(); !foundScopes_1_1.done; foundScopes_1_1 = foundScopes_1.next()) {
                var sc = foundScopes_1_1.value;
            ...
            try {
                if (foundScopes_1_1 && !foundScopes_1_1.done && (_b = foundScopes_1.return)) _b.call(foundScopes_1);
            }
    ...
    MemoryManager.prototype.getStartNodesForTrekingFunctionScope = function (func) {
        var e_5, _a;
        var allNodesInFunc = (0, utils_1.getAllNodesInFunction)(func);
        var startNodes = [];
        try {
            for (var allNodesInFunc_1 = __values(allNodesInFunc), allNodesInFunc_1_1 = allNodesInFunc_1.next(); !allNodesInFunc_1_1.done; allNodesInFunc_1_1 = allNodesInFunc_1.next()) {
                var node = allNodesInFunc_1_1.value;
                var type = this.typeHelper.getCType(node);
            ...
            try {
                if (allNodesInFunc_1_1 && !allNodesInFunc_1_1.done && (_a = allNodesInFunc_1.return)) _a.call(allNodesInFunc_1);
            }
    ...
    MemoryManager.prototype.addIfFoundInAssignment = function (varIdent, ref, queue, nodeFunc) {
        if (ref.parent && ref.parent.kind == ts.SyntaxKind.VariableDeclaration) {
            ...
            if ((0, utils_1.isEqualsExpression)(binaryExpr) && binaryExpr.right === ref) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CAssignment = exports.AssignmentHelper = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CNew = exports.CCallExpression = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var standard_1 = require("../standard");
var template_1 = require("../template");
...
var CCallExpression = /** @class */ (function (_super) {
    ...
    function CCallExpression(scope, call) {
        ...
        _this.isSimpleClosureCall = false;
        _this.closureVarName = null;
        ...
        if (funcType.needsClosureStruct) {
            ...
            if (_this.funcName instanceof CCallExpression_1) {
                _this.closureVarName = scope.root.symbolsHelper.addTemp(call, "tmp_closure");
                scope.variables.push(new variable_1.CVariable(scope, _this.closureVarName, funcType));
                _this.arguments.push(_this.closureVarName);
            }
            else {
                _this.arguments.push(_this.funcName);
                _this.isSimpleClosureCall = true;
            }
        }
        else {
            var _loop_1 = function (p) {
                var parentFunc = (0, utils_1.findParentFunction)(call);
            ...
            var this_1 = this;
            try {
                for (var _b = __values(funcType.closureParams), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var p = _c.value;
                    _loop_1(p);
                }
            }
    ...
    CCallExpression_1 = CCallExpression;
    var CCallExpression_1;
    CCallExpression = CCallExpression_1 = __decorate([
...
var CNew = /** @class */ (function (_super) {
    ...
    function CNew(scope, node) {
        ...
        if (decl && ts.isIdentifier(node.expression)) {
            ...
            if (node.arguments.length === 0 || (0, utils_1.isNullOrUndefined)(node.arguments[0])) {
                var objLiteral = ts.factory.createObjectLiteralExpression();
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CArraySize = exports.CSimpleElementAccess = exports.CElementAccess = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var template_1 = require("../template");
var ctypes_1 = require("../types/ctypes");
var literals_1 = require("./literals");
...
var CElementAccess = /** @class */ (function (_super) {
    ...
    function CElementAccess(scope, node) {
        ...
        if (ts.isIdentifier(node)) {
            ...
            if ((0, utils_1.isInBoolContext)(node) && type instanceof ctypes_1.ArrayType && !type.isDynamicArray) {
        ...
        var parentFunc = (0, utils_1.findParentFunction)(node);
    ...
    CElementAccess = CElementAccess_1 = __decorate([
        (0, template_1.CodeTemplate)("{simpleAccessor}", [ts.SyntaxKind.ElementAccessExpression, ts.SyntaxKind.PropertyAccessExpression, ts.SyntaxKind.Identifier])
    ], CElementAccess);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CBinaryExpression = exports.CCondition = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
...
var CBinaryExpression = /** @class */ (function (_super) {
    ...
    function CBinaryExpression(scope, node) {
        ...
        if (node.operatorToken.kind == ts.SyntaxKind.CommaToken) {
            var nodeAsStatement = ts.factory.createExpressionStatement(node.left);
        ...
        if ((0, utils_1.isNumberOp)(node.operatorToken.kind) || (0, utils_1.isIntegerOp)(node.operatorToken.kind)) {
            _this.expression = new CArithmeticExpression(scope, node);
            return _this;
        }
        if ((0, utils_1.isRelationalOp)(node.operatorToken.kind)) {
            _this.expression = new CRelationalExpression(scope, node);
            return _this;
        }
        if ((0, utils_1.isEqualityOp)(node.operatorToken.kind)) {
        ...
        if ((0, utils_1.isLogicOp)(node.operatorToken.kind)) {
...
var CLogicExpession = /** @class */ (function (_super) {
    ...
    function CLogicExpession(scope, node) {
        ...
        _this.isBoolContext = (0, utils_1.isInBoolContext)(node) && type !== ctypes_1.UniversalVarType;
        var isOr = node.operatorToken.kind === ts.SyntaxKind.BarBarToken;
        if (_this.isBoolContext) {
            _this.operator = isOr ? "||" : "&&";
        }
        else {
            if (!(0, utils_1.isSimpleNode)(node.left)) {
            ...
            if (!(0, utils_1.isSimpleNode)(node.right)) {
...
var CArithmeticExpression = /** @class */ (function (_super) {
    ...
    function CArithmeticExpression(scope, node) {
        ...
        _this.isCompoundAssignment = (0, utils_1.isCompoundAssignment)(node.operatorToken);
        if ((0, utils_1.toNumberCanBeNaN)(leftType) || (0, utils_1.toNumberCanBeNaN)(rightType)) {
...
var CInExpression = /** @class */ (function (_super) {
    ...
    function CInExpression(scope, node) {
        ...
        if (type instanceof ctypes_1.ArrayType) {
            ...
            if ((0, utils_1.toNumberCanBeNaN)(keyType)) {
        ...
        if (ts.isStringLiteral(node.left)) {
            var ident_1 = ts.factory.createIdentifier(node.left.text);
            var propAccess_1 = ts.factory.createPropertyAccessExpression(node.right, ident_1);
            var standardCall = ts.factory.createCallExpression(propAccess_1, [], []);
...
var CUnaryExpression = /** @class */ (function (_super) {
    ...
    function CUnaryExpression(scope, node) {
        ...
        if (node.operator === ts.SyntaxKind.PlusToken)
            ...
            _this.before = "-";
            _this.operand = new typeconvert_1.CAsNumber(scope, node.operand);
            if ((0, utils_1.toNumberCanBeNaN)(type)) {
            ...
            if (_this.isPostfix) {
                ...
                else if (!isDict && !(0, utils_1.toNumberCanBeNaN)(type)) {
                    _this.isCompound = true;
                    _this.operand = new typeconvert_1.CAsNumber(scope, node.operand);
                    _this.after = plus_1 ? " + 1" : " - 1";
                }
                else if (isTopExpressionOfStatement) {
                    var applyOperation = plus_1 ? ts.factory.createAdd : ts.factory.createSubtract;
                    var binExpr = applyOperation(node.operand, ts.factory.createNumericLiteral("1"));
                    binExpr.parent = node;
            ...
            _this.operand = "/* not supported unary expression ".concat(node.getText(), " */");
        }
        return _this;
    }
...
var CTernaryExpression = /** @class */ (function (_super) {
    ...
    CTernaryExpression = __decorate([
        (0, template_1.CodeTemplate)("{condition} ? {whenTrue} : {whenFalse}", ts.SyntaxKind.ConditionalExpression)
    ], CTernaryExpression);
...
var CGroupingExpression = /** @class */ (function (_super) {
    ...
    CGroupingExpression = __decorate([
        (0, template_1.CodeTemplate)("({expression})", ts.SyntaxKind.ParenthesizedExpression)
    ], CGroupingExpression);
...
var CVoid = /** @class */ (function (_super) {
    ...
    CVoid = __decorate([
        (0, template_1.CodeTemplate)("js_var_to_undefined({expression})", ts.SyntaxKind.VoidExpression)
    ], CVoid);
    return CVoid;
}(template_1.CTemplateBase));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CFunctionExpression = exports.CFunction = exports.CFunctionPrototype = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var template_1 = require("../template");
var variable_1 = require("./variable");
var ctypes_1 = require("../types/ctypes");
...
var CFunctionPrototype = /** @class */ (function (_super) {
    ...
    CFunctionPrototype = __decorate([
        (0, template_1.CodeTemplate)("{returnType} {name}({parameters {, }=> {this}});")
    ], CFunctionPrototype);
...
var CFunction = /** @class */ (function (_super) {
    ...
    function CFunction(root, node) {
        ...
        if (!_this.name) {
            ...
            if ((0, utils_1.isEqualsExpression)(node.parent) && node.parent.right == node && ts.isIdentifier(node.parent.left))
            ...
            if (ts.isPropertyAssignment(node.parent) && ts.isIdentifier(node.parent.name))
                funcExprName = node.parent.name.text + "_func";
            _this.name = root.symbolsHelper.addTemp((0, utils_1.findParentSourceFile)(node), funcExprName);
        }
        var funcType = root.typeHelper.getCType(node);
        _this.funcDecl = new variable_1.CVariable(_this, _this.name, funcType.returnType, { removeStorageSpecifier: true, arraysToPointers: true, funcDecl: true });
        ...
        if (funcType.needsClosureStruct) {
            ...
            try {
                for (var _c = __values(funcType.closureParams), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var p = _d.value;
                    var type = root.typeHelper.getCType(p.node);
                    var ptype = p.assigned ? (0, ctypes_1.getTypeText)(type) + "*" : type;
        ...
        try {
            for (var _e = __values(_this.gcVarNames), _f = _e.next(); !_f.done; _f = _e.next()) {
                var gcVarName = _f.value;
                _loop_1(gcVarName);
            }
        }
        catch (e_3_1) { e_3 = { error: e_3_1 }; }
        ...
        var nodesInFunction = (0, utils_1.getAllNodesUnder)(node);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CThis = exports.CNaN = exports.CUndefined = exports.CNull = exports.CBoolean = exports.CNumber = exports.CString = exports.CObjectLiteralExpression = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var template_1 = require("../template");
var ctypes_1 = require("../types/ctypes");
var variable_1 = require("./variable");
...
var CRegexLiteralExpression = /** @class */ (function (_super) {
    ...
    CRegexLiteralExpression = __decorate([
        (0, template_1.CodeTemplate)("{expression}", ts.SyntaxKind.RegularExpressionLiteral)
...
var CString = /** @class */ (function (_super) {
    ...
    CString = __decorate([
        (0, template_1.CodeTemplate)("{value}", ts.SyntaxKind.StringLiteral)
    ], CString);
    return CString;
}(template_1.CTemplateBase));
...
var CNumber = /** @class */ (function () {
    ...
    CNumber = __decorate([
        (0, template_1.CodeTemplate)("{value}", ts.SyntaxKind.NumericLiteral)
    ], CNumber);
    return CNumber;
}());
...
var CBoolean = /** @class */ (function (_super) {
    ...
    CBoolean = __decorate([
        (0, template_1.CodeTemplate)("{value}", [ts.SyntaxKind.TrueKeyword, ts.SyntaxKind.FalseKeyword])
    ], CBoolean);
    return CBoolean;
}(template_1.CTemplateBase));
...
var CNull = /** @class */ (function (_super) {
    ...
    CNull = __decorate([
        (0, template_1.CodeTemplate)("js_var_from(JS_VAR_NULL)", ts.SyntaxKind.NullKeyword)
    ], CNull);
    return CNull;
}(template_1.CTemplateBase));
exports.CNull = CNull;
var CUndefined = /** @class */ (function (_super) {
    ...
    CUndefined = __decorate([
        (0, template_1.CodeTemplate)("js_var_from(JS_VAR_UNDEFINED)", ts.SyntaxKind.UndefinedKeyword)
    ], CUndefined);
    return CUndefined;
}(template_1.CTemplateBase));
...
var CNaN = /** @class */ (function (_super) {
    ...
    CNaN = __decorate([
        (0, template_1.CodeTemplate)("js_var_from(JS_VAR_NAN)", ts.SyntaxKind.Count + 1)
    ], CNaN);
    return CNaN;
}(template_1.CTemplateBase));
exports.CNaN = CNaN;
var CThis = /** @class */ (function (_super) {
    ...
    CThis = __decorate([
        (0, template_1.CodeTemplate)("this", ts.SyntaxKind.ThisKeyword)
    ], CThis);
    return CThis;
}(template_1.CTemplateBase));
exports.CThis = CThis;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CRegexAsString = exports.CRegexSearchFunction = void 0;
var template_1 = require("../template");
var literals_1 = require("./literals");
...
var CRegexSearchFunction = /** @class */ (function (_super) {
    ...
    function CRegexSearchFunction(scope, template, regexName, regexMachine) {
        ...
        _this.hasChars = regexMachine.states.filter(function (s) { return s && s.transitions.filter(function (c) { return typeof c.condition == "string" || (0, regex_1.isRangeCondition)(c.condition) || c.condition.tokens.length > 0; }); }).length > 0;
...
var CharCondition = /** @class */ (function (_super) {
    ...
    function CharCondition(tr, groupN) {
        ...
        else if ((0, regex_1.isRangeCondition)(tr.condition)) {
        ...
        try {
            for (var _c = __values(tr.startGroup || []), _d = _c.next(); !_d.done; _d = _c.next()) {
                var g = _d.value;
        ...
        try {
            for (var _e = __values(tr.endGroup || []), _f = _e.next(); !_f.done; _f = _e.next()) {
                var g = _f.value;
...
var CRegexAsString = /** @class */ (function (_super) {
    ...
    CRegexAsString = __decorate([
        (0, template_1.CodeTemplate)("{expression}.str")
    ], CRegexAsString);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CThrowStatement = exports.CTryStatement = exports.CImport = exports.CBlock = exports.CExpressionStatement = exports.CForInStatement = exports.CForOfStatement = exports.CForStatement = exports.CDoWhileStatement = exports.CWhileStatement = exports.CSwitchStatement = exports.CIfStatement = exports.CReturnStatement = exports.CEmptyStatement = exports.CContinueStatement = exports.CBreakStatement = exports.CLabeledStatement = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var template_1 = require("../template");
var ctypes_1 = require("../types/ctypes");
var variable_1 = require("./variable");
...
var CLabeledStatement = /** @class */ (function (_super) {
    ...
    function CLabeledStatement(scope, node) {
        var _this = _super.call(this) || this;
        var nodes = (0, utils_1.getAllNodesUnder)(node);
    ...
    CLabeledStatement = __decorate([
        (0, template_1.CodeTemplate)("{statement}{breakLabel}", ts.SyntaxKind.LabeledStatement)
    ], CLabeledStatement);
...
var CSwitchCaseClause = /** @class */ (function (_super) {
    ...
    function CSwitchCaseClause(scope, clause, index) {
        ...
        try {
            for (var _b = __values(clause.statements), _c = _b.next(); !_c.done; _c = _b.next()) {
                var s = _c.value;
...
var CSwitchCaseCompare = /** @class */ (function (_super) {
    ...
    CSwitchCaseCompare = __decorate([
        (0, template_1.CodeTemplate)("!strcmp({expression}, {value}) ? {index}")
    ], CSwitchCaseCompare);
...
var CExpressionStatement = /** @class */ (function (_super) {
    ...
    CExpressionStatement = __decorate([
        (0, template_1.CodeTemplate)("{expression}{SemicolonCR}", ts.SyntaxKind.ExpressionStatement)
...
var CImport = /** @class */ (function (_super) {
    ...
    CImport = __decorate([
        (0, template_1.CodeTemplate)("", ts.SyntaxKind.ImportDeclaration)
    ], CImport);
    return CImport;
}(template_1.CTemplateBase));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CAsString_Concat = exports.CAsString_Length = exports.CAsString = exports.CAsNumber = exports.CAsUniversalVar = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var ctypes_1 = require("../types/ctypes");
var template_1 = require("../template");
var utils_1 = require("../types/utils");
...
var CAsUniversalVar = /** @class */ (function (_super) {
    ...
    function CAsUniversalVar(scope, expr, type) {
        var _this = _super.call(this) || this;
        _this.expression = (0, utils_1.isNode)(expr) ? template_1.CodeTemplateFactory.createForNode(scope, expr) : expr;
        type = type || (0, utils_1.isNode)(expr) && scope.root.typeHelper.getCType(expr);
        _this.isUniversalVar = type === ctypes_1.UniversalVarType;
        _this.isString = type === ctypes_1.StringVarType;
        _this.isNumber = type === ctypes_1.NumberVarType;
        _this.isBoolean = type === ctypes_1.BooleanVarType;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CVariable = exports.CVariableDestructors = exports.CVariableAllocation = exports.CVariableDeclaration = exports.CVariableDeclarationList = exports.CVariableStatement = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var template_1 = require("../template");
var ctypes_1 = require("../types/ctypes");
var assignment_1 = require("./assignment");
...
var CVariableStatement = /** @class */ (function (_super) {
    ...
    CVariableStatement = __decorate([
        (0, template_1.CodeTemplate)("{declarations}", ts.SyntaxKind.VariableStatement)
    ], CVariableStatement);
...
var CVariableDeclarationList = /** @class */ (function (_super) {
    ...
    CVariableDeclarationList = __decorate([
        (0, template_1.CodeTemplate)("{declarations}", ts.SyntaxKind.VariableDeclarationList)
...
var CVariableDeclaration = /** @class */ (function (_super) {
    ...
    CVariableDeclaration = __decorate([
        (0, template_1.CodeTemplate)("{initializer}", ts.SyntaxKind.VariableDeclaration)
...
var CVariableDestructors = /** @class */ (function (_super) {
    ...
    function CVariableDestructors(scope, node) {
        ...
        try {
            for (var gcVarNames_1 = __values(gcVarNames), gcVarNames_1_1 = gcVarNames_1.next(); !gcVarNames_1_1.done; gcVarNames_1_1 = gcVarNames_1.next()) {
                var gc = gcVarNames_1_1.value;
            ...
            try {
                if (gcVarNames_1_1 && !gcVarNames_1_1.done && (_a = gcVarNames_1.return)) _a.call(gcVarNames_1);
            }
            finally { if (e_1) throw e_1.error; }
        }
        _this.destructors = [];
...
var CVariable = /** @class */ (function (_super) {
    ...
    function CVariable(scope, name, typeSource, options) {
        var _this = _super.call(this) || this;
        _this.name = name;
        var type = (0, utils_1.isNode)(typeSource) ? scope.root.typeHelper.getCType(typeSource) : typeSource;
        if (type instanceof ctypes_1.StructType)
        ...
        _this.funcDecl = options && options.funcDecl;
        _this.type = type;
    ...
    CVariable.prototype.resolve = function () {
        var varString;
        if (this.funcDecl && this.type instanceof ctypes_1.FuncType)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CProgram = exports.reservedCSymbolNames = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var utils_1 = require("./types/utils");
...
var CProgram = /** @class */ (function () {
    function CProgram(tsProgram) {
        ...
        var nodesToRename = new Set(), symbolsToRename = new Set();
        try {
            for (var nodes_1 = __values(nodes), nodes_1_1 = nodes_1.next(); !nodes_1_1.done; nodes_1_1 = nodes_1.next()) {
                ...
                if (ts.isIdentifier(n)) {
                    ...
                    if (symbol) {
                        ...
                        if (symbol.flags & (ts.SymbolFlags.Variable | ts.SymbolFlags.Function | ts.SymbolFlags.Class | ts.SymbolFlags.Enum)) {
                            if (exports.reservedCSymbolNames.indexOf(symbol.name) > -1) {
                                nodesToRename.add(n);
                ...
                if (iifeVariant1 || iifeVariant2) {
                    var iife = n;
                    var returns = (0, utils_1.getAllNodesInFunction)(iife).filter(ts.isReturnStatement);
                    if (returns.length === 0) {
                        var replacee = iife.parent.parent;
                        var statements = iife.body.statements;
                        var replacement = ts.factory.createBlock(statements);
                        ...
                        try {
                            for (var _k = (e_3 = void 0, __values(Object.getOwnPropertyNames(replacee))), _l = _k.next(); !_l.done; _l = _k.next()) {
                                var prop = _l.value;
                        ...
                        try {
                            for (var _m = (e_4 = void 0, __values(Object.getOwnPropertyNames(replacement))), _o = _m.next(); !_o.done; _o = _m.next()) {
                                var prop = _o.value;
        ...
        var _loop_1 = function (n) {
            var newText = n.escapedText + '_';
            n.escapedText = newText;
            n.getText = function () { return newText; };
        };
        try {
            ...
            for (var nodesToRename_1 = __values(nodesToRename), nodesToRename_1_1 = nodesToRename_1.next(); !nodesToRename_1_1.done; nodesToRename_1_1 = nodesToRename_1.next()) {
                var n = nodesToRename_1_1.value;
                _loop_1(n);
            }
        }
        catch (e_5_1) { e_5 = { error: e_5_1 }; }
            ...
            try {
                if (nodesToRename_1_1 && !nodesToRename_1_1.done && (_e = nodesToRename_1.return)) _e.call(nodesToRename_1);
            }
            finally { if (e_5) throw e_5.error; }
        }
        try {
            for (var symbolsToRename_1 = __values(symbolsToRename), symbolsToRename_1_1 = symbolsToRename_1.next(); !symbolsToRename_1_1.done; symbolsToRename_1_1 = symbolsToRename_1.next()) {
                var symbol = symbolsToRename_1_1.value;
                symbol.escapedName = symbol.escapedName + '_';
            }
        }
        catch (e_6_1) { e_6 = { error: e_6_1 }; }
        finally {
            try {
                if (symbolsToRename_1_1 && !symbolsToRename_1_1.done && (_f = symbolsToRename_1.return)) _f.call(symbolsToRename_1);
            }
        ...
        try {
            for (var _p = __values(this.gcVarNames), _q = _p.next(); !_q.done; _q = _p.next()) {
                var gcVarName = _q.value;
        ...
        try {
            for (var sources_2 = __values(sources), sources_2_1 = sources_2.next(); !sources_2_1.done; sources_2_1 = sources_2.next()) {
                ...
                try {
                    for (var _r = (e_9 = void 0, __values(source.statements)), _s = _r.next(); !_s.done; _s = _r.next()) {
                        var s = _s.value;
            ...
            try {
                if (sources_2_1 && !sources_2_1.done && (_h = sources_2.return)) _h.call(sources_2);
            }
            finally { if (e_8) throw e_8.error; }
        }
        var _t = __read(this.symbolsHelper.getStructsAndFunctionPrototypes(), 1), structs = _t[0];
        ...
        while (i < template.length) {
            ...
            if (template[i] == '^' && tokens.length == 0)
                ...
                if (typeof last === "string")
                    ...
                    tokens.push({ anyOf: true, tokens: [NOTHING, __assign(__assign({}, last), { oneOrMore: true })] });
            }
            else if (template[i] == '?')
                ...
                i += 2, (_c = this.parseChars(template, i, 'anyCharExcept'), _d = __read(_c, 2), tok = _d[0], i = _d[1], _c) && tok && tokens.push(tok);
            else if (template[i] == '[')
                i++, (_e = this.parseChars(template, i, 'anyOf'), _f = __read(_e, 2), tok = _f[0], i = _f[1], _e) && tok && tokens.push(tok);
            else
...
var RegexBuilder = /** @class */ (function () {
    ...
    RegexBuilder.convert = function (token, transitions, firstFromState, finalState) {
        ...
        if (typeof token == "string" || token.anyCharExcept) {
            ...
            if (token.tokens.indexOf(NOTHING) > -1)
                ...
                nextFromState = [];
            try {
                for (var _e = __values(token.tokens.filter(function (t) { return t != NOTHING && t != FIXED_START && t != FIXED_END && !isStartGroup(t) && !isEndGroup(t); })), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var tok = _f.value;
            ...
            try {
                for (var _g = __values(token.tokens.filter(function (t) { return t != FIXED_START && t != FIXED_END && !isStartGroup(t) && !isEndGroup(t); })), _h = _g.next(); !_h.done; _h = _g.next()) {
                    var tok = _h.value;
                    var results = [];
                    var lastTransitions = [];
                    ...
                    var this_1 = this;
                    try {
                        for (var nextFromState_1 = (e_3 = void 0, __values(nextFromState)), nextFromState_1_1 = nextFromState_1.next(); !nextFromState_1_1.done; nextFromState_1_1 = nextFromState_1.next()) {
                            var fromState = nextFromState_1_1.value;
                            _loop_1(fromState);
                        }
                    }
                    catch (e_3_1) { e_3 = { error: e_3_1 }; }
                        ...
                        try {
                            if (nextFromState_1_1 && !nextFromState_1_1.done && (_c = nextFromState_1.return)) _c.call(nextFromState_1);
                        }
                        finally { if (e_3) throw e_3.error; }
                    }
        ...
        if (typeof token != "string" && token.oneOrMore) {
            try {
                for (var _j = __values(transitions.filter(function (t) { return t.toState == finalState; })), _k = _j.next(); !_k.done; _k = _j.next()) {
                    var tr = _k.value;
                    transitions.push(__assign(__assign({}, tr), { toState: firstFromState }));
                }
            }
            catch (e_4_1) { e_4 = { error: e_4_1 }; }
            finally {
    ...
    RegexBuilder.normalize = function (transitions, finalStates) {
        ...
        try {
            for (var finalStates_1 = __values(finalStates), finalStates_1_1 = finalStates_1.next(); !finalStates_1_1.done; finalStates_1_1 = finalStates_1.next()) {
                var finalState = finalStates_1_1.value;
                _loop_2(finalState);
            }
        }
        catch (e_5_1) { e_5 = { error: e_5_1 }; }
            ...
            try {
                if (finalStates_1_1 && !finalStates_1_1.done && (_a = finalStates_1.return)) _a.call(finalStates_1);
            }
            finally { if (e_5) throw e_5.error; }
        }
        ...
        var _loop_3 = function (anyCharT) {
            ...
            try {
                for (var charTransitions_1 = (e_8 = void 0, __values(charTransitions)), charTransitions_1_1 = charTransitions_1.next(); !charTransitions_1_1.done; charTransitions_1_1 = charTransitions_1.next()) {
                    var charT = charTransitions_1_1.value;
                    _loop_5(charT);
                }
            }
            catch (e_8_1) { e_8 = { error: e_8_1 }; }
                ...
                try {
                    if (charTransitions_1_1 && !charTransitions_1_1.done && (_d = charTransitions_1.return)) _d.call(charTransitions_1);
                }
                finally { if (e_8) throw e_8.error; }
            }
        };
        try {
            for (var anyCharTransitions_1 = __values(anyCharTransitions), anyCharTransitions_1_1 = anyCharTransitions_1.next(); !anyCharTransitions_1_1.done; anyCharTransitions_1_1 = anyCharTransitions_1.next()) {
                var anyCharT = anyCharTransitions_1_1.value;
                _loop_3(anyCharT);
            }
        }
        catch (e_6_1) { e_6 = { error: e_6_1 }; }
            ...
            try {
                if (anyCharTransitions_1_1 && !anyCharTransitions_1_1.done && (_b = anyCharTransitions_1.return)) _b.call(anyCharTransitions_1);
            }
            finally { if (e_6) throw e_6.error; }
        }
        ...
        var _loop_4 = function () {
            ...
            try {
                for (var _f = (e_9 = void 0, __values(trgroup.filter(function (t) { return !!t.token; }))), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var tr = _g.value;
                    _loop_6(tr);
                }
            }
                    ...
                    for (var i_1 = 1; i_1 <= charTransitions_2.length; i_1++) {
                        if (i_1 < charTransitions_2.length
                            ...
                            if (condition.fromChar == condition.toChar) {
                                ...
                                classTransitions.push(__assign(__assign({}, charTransitions_2[i_1 - 1]), { condition: condition }));
                            }
                            if (i_1 < charTransitions_2.length)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.StandardCallHelper = void 0;
...
var StandardCallHelper = /** @class */ (function () {
    ...
    StandardCallHelper.isStandardCall = function (typeHelper, node) {
        ...
        if (!ts.isCallExpression(node))
            return false;
        try {
            for (var standardCallResolvers_1 = __values(standardCallResolvers), standardCallResolvers_1_1 = standardCallResolvers_1.next(); !standardCallResolvers_1_1.done; standardCallResolvers_1_1 = standardCallResolvers_1.next()) {
                var resolver = standardCallResolvers_1_1.value;
            ...
            try {
                if (standardCallResolvers_1_1 && !standardCallResolvers_1_1.done && (_a = standardCallResolvers_1.return)) _a.call(standardCallResolvers_1);
            }
            finally { if (e_1) throw e_1.error; }
        }
        return false;
    ...
    StandardCallHelper.createTemplate = function (scope, node) {
        var e_2, _a;
        try {
            for (var standardCallResolvers_2 = __values(standardCallResolvers), standardCallResolvers_2_1 = standardCallResolvers_2.next(); !standardCallResolvers_2_1.done; standardCallResolvers_2_1 = standardCallResolvers_2.next()) {
                var resolver = standardCallResolvers_2_1.value;
            ...
            try {
                if (standardCallResolvers_2_1 && !standardCallResolvers_2_1.done && (_a = standardCallResolvers_2.return)) _a.call(standardCallResolvers_2);
            }
            finally { if (e_2) throw e_2.error; }
        }
        return null;
    ...
    StandardCallHelper.getObjectType = function (typeHelper, node) {
        var e_3, _a;
        try {
            for (var standardCallResolvers_3 = __values(standardCallResolvers), standardCallResolvers_3_1 = standardCallResolvers_3.next(); !standardCallResolvers_3_1.done; standardCallResolvers_3_1 = standardCallResolvers_3.next()) {
                var resolver = standardCallResolvers_3_1.value;
            ...
            try {
                if (standardCallResolvers_3_1 && !standardCallResolvers_3_1.done && (_a = standardCallResolvers_3.return)) _a.call(standardCallResolvers_3);
            }
            finally { if (e_3) throw e_3.error; }
        }
        return null;
    ...
    StandardCallHelper.getArgumentTypes = function (typeHelper, node) {
        ...
        try {
            for (var standardCallResolvers_4 = __values(standardCallResolvers), standardCallResolvers_4_1 = standardCallResolvers_4.next(); !standardCallResolvers_4_1.done; standardCallResolvers_4_1 = standardCallResolvers_4.next()) {
                var resolver = standardCallResolvers_4_1.value;
                if (resolver.matchesNode(typeHelper, node, { determineObjectType: true }))
            ...
            try {
                if (standardCallResolvers_4_1 && !standardCallResolvers_4_1.done && (_a = standardCallResolvers_4.return)) _a.call(standardCallResolvers_4);
            }
            finally { if (e_4) throw e_4.error; }
        }
        return notDefined;
    ...
    StandardCallHelper.getReturnType = function (typeHelper, node) {
        var e_5, _a;
        try {
            for (var standardCallResolvers_5 = __values(standardCallResolvers), standardCallResolvers_5_1 = standardCallResolvers_5.next(); !standardCallResolvers_5_1.done; standardCallResolvers_5_1 = standardCallResolvers_5.next()) {
                var resolver = standardCallResolvers_5_1.value;
                if (resolver.matchesNode(typeHelper, node))
            ...
            try {
                if (standardCallResolvers_5_1 && !standardCallResolvers_5_1.done && (_a = standardCallResolvers_5.return)) _a.call(standardCallResolvers_5);
            }
            finally { if (e_5) throw e_5.error; }
        }
        return null;
    ...
    StandardCallHelper.needsDisposal = function (typeHelper, node) {
        var e_6, _a;
        try {
            for (var standardCallResolvers_6 = __values(standardCallResolvers), standardCallResolvers_6_1 = standardCallResolvers_6.next(); !standardCallResolvers_6_1.done; standardCallResolvers_6_1 = standardCallResolvers_6.next()) {
                var resolver = standardCallResolvers_6_1.value;
                if (resolver.matchesNode(typeHelper, node))
            ...
            try {
                if (standardCallResolvers_6_1 && !standardCallResolvers_6_1.done && (_a = standardCallResolvers_6.return)) _a.call(standardCallResolvers_6);
            }
            finally { if (e_6) throw e_6.error; }
        }
        return false;
    ...
    StandardCallHelper.getTempVarName = function (typeHelper, node) {
        var e_7, _a;
        try {
            for (var standardCallResolvers_7 = __values(standardCallResolvers), standardCallResolvers_7_1 = standardCallResolvers_7.next(); !standardCallResolvers_7_1.done; standardCallResolvers_7_1 = standardCallResolvers_7.next()) {
                var resolver = standardCallResolvers_7_1.value;
                if (resolver.matchesNode(typeHelper, node))
            ...
            try {
                if (standardCallResolvers_7_1 && !standardCallResolvers_7_1.done && (_a = standardCallResolvers_7.return)) _a.call(standardCallResolvers_7);
            }
            finally { if (e_7) throw e_7.error; }
        }
    ...
    StandardCallHelper.getEscapeNode = function (typeHelper, node) {
        var e_8, _a;
        try {
            for (var standardCallResolvers_8 = __values(standardCallResolvers), standardCallResolvers_8_1 = standardCallResolvers_8.next(); !standardCallResolvers_8_1.done; standardCallResolvers_8_1 = standardCallResolvers_8.next()) {
                var resolver = standardCallResolvers_8_1.value;
                if (resolver.matchesNode(typeHelper, node))
            ...
            try {
                if (standardCallResolvers_8_1 && !standardCallResolvers_8_1.done && (_a = standardCallResolvers_8.return)) _a.call(standardCallResolvers_8);
            }
            finally { if (e_8) throw e_8.error; }
        }
        return null;
...
var CArrayIndexOf = /** @class */ (function (_super) {
    ...
    function CArrayIndexOf(scope, call) {
        ...
        if (!_this.topExpressionOfStatement) {
            ...
            var iteratorIdent = ts.factory.createIdentifier(_this.iteratorVarName);
            var arrayElement = ts.factory.createElementAccessExpression(propAccess.expression, iteratorIdent);
            var comparison = ts.factory.createBinaryExpression(arrayElement, ts.SyntaxKind.EqualsEqualsToken, call.arguments[0]);
...
var CArrayPop = /** @class */ (function (_super) {
    ...
    CArrayPop = __decorate([
        (0, template_1.CodeTemplate)("ARRAY_POP({varAccess})")
    ], CArrayPop);
    return CArrayPop;
}(template_1.CTemplateBase));
...
var CPushValue = /** @class */ (function () {
    ...
    CPushValue = __decorate([
        (0, template_1.CodeTemplate)("ARRAY_PUSH({varAccess}, {value});\n")
    ], CPushValue);
    return CPushValue;
}());
...
var CInsertValue = /** @class */ (function () {
    ...
    CInsertValue = __decorate([
        (0, template_1.CodeTemplate)("ARRAY_INSERT({varAccess}, {startIndex}, {value});\n")
    ], CInsertValue);
    return CInsertValue;
}());
...
var CUnshiftValue = /** @class */ (function (_super) {
    ...
    CUnshiftValue = __decorate([
        (0, template_1.CodeTemplate)("ARRAY_INSERT({varAccess}, 0, {value});\n")
    ], CUnshiftValue);
    ...
    function CConsoleLog(scope, node) {
        ...
        var _loop_1 = function (i_1) {
            ...
            for (var j = 0; j < nodeExpressions.length; j++) {
                ...
                var nodesUnder = (0, utils_1.getAllNodesUnder)(node_1);
                var hasSideEffects = nodesUnder.some(function (n) { return (0, utils_1.isSideEffectExpression)(n); });
                var accessor = "";
                if (hasSideEffects && (type instanceof ctypes_1.ArrayType || type instanceof ctypes_1.StructType || type instanceof ctypes_1.DictType || type === ctypes_1.UniversalVarType)) {
                    ...
                    if (tempVarType instanceof ctypes_1.ArrayType && !tempVarType.isDynamicArray)
                        tempVarType = (0, ctypes_1.getTypeText)(tempVarType.elementType) + "*";
        ...
        if (varType instanceof ctypes_1.ArrayType) {
            ...
            for (var k in varType.properties) {
                ...
                if (varType.propertyDefs[k].recursive) {
                    ...
                    var stringLit = ts.factory.createStringLiteral(objString);
...
var CIsNaN = /** @class */ (function (_super) {
    ...
    CIsNaN = __decorate([
        (0, template_1.CodeTemplate)("js_var_isnan({argument})")
    ], CIsNaN);
    return CIsNaN;
}(template_1.CTemplateBase));
...
var CParseInt = /** @class */ (function (_super) {
    ...
    CParseInt = __decorate([
        (0, template_1.CodeTemplate)("parse_int16_t({arguments {, }=> {this}})")
    ], CParseInt);
    return CParseInt;
}(template_1.CTemplateBase));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.StringMatchResolver = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
var template_1 = require("../../template");
var standard_1 = require("../../standard");
var ctypes_1 = require("../../types/ctypes");
...
var SymbolsHelper = /** @class */ (function () {
    function SymbolsHelper(typeChecker, typeHelper) {
        ...
        this.temporaryVariables = {
            "main": program_1.reservedCSymbolNames
        };
    ...
    SymbolsHelper.prototype.getStructsAndFunctionPrototypes = function () {
        ...
        var _this = this;
        try {
            for (var _b = __values(this.arrayStructs), _c = _b.next(); !_c.done; _c = _b.next()) {
                var arrElemType = _c.value;
    ...
    SymbolsHelper.prototype.addIterator = function (scopeNode) {
        var parentFunc = (0, utils_1.findParentFunction)(scopeNode);
    ...
    SymbolsHelper.prototype.getClosureVarName = function (node) {
        if (!this.closureVarNames[node.pos]) {
            var name = this.addTemp(node, "closure");
    ...
    SymbolsHelper.prototype.getScopeVarName = function (node) {
        if (!this.scopeVarNames[node.pos]) {
            var name = this.addTemp(node, "scope");
...
},{"./program":12,"./types/ctypes":44,"./types/utils":49}],43:[function(require,module,exports){
"use strict";
var __read = (this && this.__read) || function (o, n) {
    var m = typeof Symbol === "function" && o[Symbol.iterator];
    if (!m) return o;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CodeTemplateFactory = exports.CTemplateBase = void 0;
...
function CodeTemplate(tempString, nodeKind) {
    return function (target) {
        ...
        var newConstructor = function (scope, node) {
            ...
            var _a = __read(processTemplate(tempString, self), 2), code = _a[0], statements = _a[1];
            if (statements)
        ...
        if (nodeKind) {
            if (typeof nodeKind === 'number')
                ...
                try {
                    for (var nodeKind_1 = __values(nodeKind), nodeKind_1_1 = nodeKind_1.next(); !nodeKind_1_1.done; nodeKind_1_1 = nodeKind_1.next()) {
                        var nk = nodeKind_1_1.value;
                    ...
                    try {
                        if (nodeKind_1_1 && !nodeKind_1_1.done && (_a = nodeKind_1.return)) _a.call(nodeKind_1);
                    }
                    finally { if (e_1) throw e_1.error; }
                }
        }
...
function processTemplate(template, args) {
    ...
    if (template.indexOf("{#statements}") > -1) {
        ...
        var _a = __read(processTemplate(templateText, args), 2), c = _a[0], s = _a[1];
        statements += s + c;
...
function replaceArray(data, k, array, statements) {
    ...
    if (pos != -1) {
        ...
        try {
            for (var array_1 = __values(array), array_1_1 = array_1.next(); !array_1_1.done; array_1_1 = array_1.next()) {
                ...
                var _d = __read(processTemplate("{this}", element), 2), resolvedElement = _d[0], elementStatements = _d[1];
    ...
    try {
        for (var array_2 = __values(array), array_2_1 = array_2.next(); !array_2_1.done; array_2_1 = array_2.next()) {
            var element = array_2_1.value;
            var _e = __read(processTemplate(elementTemplate, element), 2), resolvedElement = _e[0], elementStatements = _e[1];
            statements += elementStatements;
            if (k == 'statements') {
                resolvedElement = resolvedElement.replace(/[;\n]+;/g, ';');
                if (resolvedElement.search(/\n/) > -1) {
                    try {
                        for (var _f = (e_4 = void 0, __values(resolvedElement.split('\n'))), _g = _f.next(); !_g.done; _g = _f.next()) {
                            var line = _g.value;
                            if (line != '') {
                                if (elementsResolved != "")
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.FuncType = exports.DictType = exports.StructType = exports.ArrayType = exports.RegexMatchVarType = exports.RegexVarType = exports.BooleanVarType = exports.NumberVarType = exports.StringVarType = exports.PointerVarType = exports.VoidType = exports.UniversalVarType = void 0;
...
var FuncType = /** @class */ (function () {
    ...
    FuncType.prototype.getPointerToTypeText = function () {
        if (this.closureParams.length)
            return 'struct ' + this.structName + ' *';
        var retType = this.returnType instanceof FuncType ?
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.CircularTypesFinder = void 0;
var ts = __importStar((typeof window !== "undefined" ? window['ts'] : typeof global !== "undefined" ? global['ts'] : null));
...
var CircularTypesFinder = /** @class */ (function () {
    ...
    CircularTypesFinder.prototype.findCircularAssignments = function () {
        ...
        this.assignments = {};
        try {
            for (var _b = __values(this.allNodes), _c = _b.next(); !_c.done; _c = _b.next()) {
                var node = _c.value;
                if ((0, utils_1.isEqualsExpression)(node) || ts.isVariableDeclaration(node)) {
                    var left = (0, utils_1.isEqualsExpression)(node) ? node.left : node.name;
                    var right = (0, utils_1.isEqualsExpression)(node) ? node.right : node.initializer;
                    if (!left || !right)
                        continue;
                    var lvar = left;
                    var leftProps = [];
                    while ((0, utils_1.isFieldPropertyAccess)(lvar) || (0, utils_1.isFieldElementAccess)(lvar)) {
                        if ((0, utils_1.isFieldPropertyAccess)(lvar))
                            leftProps.unshift(lvar.name.text);
                        else if ((0, utils_1.isFieldElementAccess)(lvar))
    ...
    CircularTypesFinder.prototype.checkOneAssignment = function (refNode, left, leftProps, right) {
        ...
        if (ts.isObjectLiteralExpression(right)) {
            try {
                for (var _b = __values(right.properties), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var prop = _c.value;
        ...
        var rightProps = [];
        while ((0, utils_1.isFieldPropertyAccess)(right) || (0, utils_1.isFieldElementAccess)(right)) {
            if ((0, utils_1.isFieldPropertyAccess)(right))
                rightProps.unshift(right.name.text);
            else if ((0, utils_1.isFieldElementAccess)(right))
...
var TypeMerger = /** @class */ (function () {
    ...
    TypeMerger.prototype.mergeTypes = function (type1, type2) {
        ...
        if (!type1 && type2)
            ...
            var _b = this.mergeTypes(type1.elementType, type2.elementType), elemType = _b.type, replaced = _b.replaced;
            if (replaced)
            ...
            var _c = this.mergeTypes(type1.returnType, type2.returnType), returnType = _c.type, returnTypeReplaced = _c.replaced;
            var _d = this.mergeTypes(type1.instanceType, type2.instanceType), instanceType = _d.type, instanceTypeReplaced = _d.replaced;
            var _e = this.mergeTypes(type1.scopeType, type2.scopeType), scopeType = _e.type, scopeTypeReplaced = _e.replaced;
            ...
            for (var i_1 = 0; i_1 < paramCount; i_1++) {
                var _f = this.mergeTypes(type1.parameterTypes[i_1], type2.parameterTypes[i_1]), pType = _f.type, pTypeReplaced = _f.replaced;
    ...
    TypeMerger.prototype.ensureNoTypeDuplicates = function (t) {
        if (!t)
            return null;
        var typeBodyText = (0, ctypes_1.getTypeBodyText)(t);
...
var TypeResolver = /** @class */ (function () {
    ...
    TypeResolver.prototype.inferTypes = function () {
        ...
        addEquality(ts.isPropertyAssignment, function (n) { return n.parent; }, type(function (n) {
            var propName = (ts.isIdentifier(n.name) || (0, utils_1.isStringLiteralAsIdentifier)(n.name)) && n.name.text;
            if (propName)
        ...
        addEquality(utils_1.isFieldElementAccess, function (n) { return n.expression; }, type(function (n) {
            ...
            return (0, utils_1.isStringLiteralAsIdentifier)(n.argumentExpression) ? struct(n.argumentExpression.text, n.pos, elementType)
        ...
        addEquality(utils_1.isFieldAssignment, function (n) { return n.left.expression; }, type(function (n) {
            if (!circularAssignments[n.pos])
                return null;
            return (0, utils_1.isFieldElementAccess)(n.left) ? struct(n.left.argumentExpression.getText().slice(1, -1), n.left.pos, ctypes_1.PointerVarType, true)
                : (0, utils_1.isFieldPropertyAccess)(n.left) ? struct(n.left.name.text, n.left.pos, ctypes_1.PointerVarType, true)
                    : null;
        }));
        ...
        addEquality(utils_1.isUnaryExpression, function (n) { return n; }, type(function (n) { return (0, utils_1.getUnaryExprResultType)(n.operator, _this.typeHelper.getCType(n.operand)); }));
        addEquality(utils_1.isUnaryExpression, function (n) { return n.operand; }, type(function (n) {
            ...
            if (resultType == ctypes_1.UniversalVarType || (0, utils_1.toNumberCanBeNaN)(resultType) || isDictAccessor)
                return ctypes_1.UniversalVarType;
            else
                return null;
        }));
        addEquality(ts.isBinaryExpression, function (n) { return n; }, type(function (n) { return (0, utils_1.getBinExprResultType)(_this.typeMerger.mergeTypes.bind(_this.typeMerger), _this.typeHelper.getCType(n.left), n.operatorToken.kind, _this.typeHelper.getCType(n.right)); }));
        addEquality(ts.isBinaryExpression, function (n) { return n.left; }, type(function (n) {
            ...
            if (resultType === ctypes_1.UniversalVarType) {
                return (0, utils_1.isCompoundAssignment)(n.operatorToken) ? ctypes_1.UniversalVarType
            ...
            else if ((0, utils_1.operandsToNumber)(operandType, n.operatorToken.kind, rightType) && (0, utils_1.toNumberCanBeNaN)(operandType))
                return ctypes_1.UniversalVarType;
            else
                return null;
        }));
        addEquality(ts.isBinaryExpression, function (n) { return n.right; }, type(function (n) {
            ...
            if (resultType === ctypes_1.UniversalVarType && !(0, utils_1.isLogicOp)(n.operatorToken.kind)) {
                return operandType instanceof ctypes_1.ArrayType ? new ctypes_1.ArrayType(ctypes_1.UniversalVarType, 0, true)
                    : operandType instanceof ctypes_1.StructType || operandType instanceof ctypes_1.DictType ? new ctypes_1.DictType(ctypes_1.UniversalVarType)
                        : null;
            }
            else if ((0, utils_1.operandsToNumber)(leftType, n.operatorToken.kind, operandType) && (0, utils_1.toNumberCanBeNaN)(operandType))
                return ctypes_1.UniversalVarType;
            else
                return null;
        }));
        ...
        addEquality(ts.isCallExpression, function (n) { return n.expression; }, type(function (n) {
            // nested call expression e.g. `func(1, 2)()`
            if (ts.isCallExpression(n) && ts.isCallExpression(n.expression)) {
                var type_1 = _this.typeHelper.getCType(n.expression);
                if (type_1 instanceof ctypes_1.FuncType && type_1.closureParams.length)
                    return new ctypes_1.FuncType({ needsClosureStruct: true });
            }
            return null;
        }));
        ...
        addEquality(utils_1.isThisKeyword, function (n) { return (0, utils_1.findParentFunction)(n); }, type(function (n) { return new ctypes_1.FuncType({ instanceType: _this.typeHelper.getCType(n) }); }));
        addEquality(utils_1.isThisKeyword, function (n) { return n; }, type(function (n) { return ctypes_1.FuncType.getInstanceType(_this.typeHelper, (0, utils_1.findParentFunction)(n)); }));
        ...
        var _loop_3 = function (i_3) {
            addEquality(ts.isCallExpression, function (n) { return n.arguments[i_3]; }, type(function (n) { return (0, utils_1.isLiteral)(n.arguments[i_3]) ? null : standard_1.StandardCallHelper.getArgumentTypes(_this.typeHelper, n)[i_3]; }));
        };
        ...
        addEquality(utils_1.isFunction, function (n) { return n; }, type(function (node) {
            var e_1, _a, e_2, _b;
            var funcsInFunction = (0, utils_1.getAllFunctionNodesInFunction)(node);
            var scopePropDefs = {};
            try {
                for (var funcsInFunction_1 = __values(funcsInFunction), funcsInFunction_1_1 = funcsInFunction_1.next(); !funcsInFunction_1_1.done; funcsInFunction_1_1 = funcsInFunction_1.next()) {
                    var f = funcsInFunction_1_1.value;
                    var fType = _this.typeHelper.getCType(f);
                    if (fType && fType.needsClosureStruct && fType.closureParams) {
                        try {
                            for (var _c = (e_2 = void 0, __values(fType.closureParams)), _d = _c.next(); !_d.done; _d = _c.next()) {
                                var p = _d.value;
                                ...
                                if ((0, utils_1.findParentFunction)(decl) === node)
                ...
                try {
                    if (funcsInFunction_1_1 && !funcsInFunction_1_1.done && (_a = funcsInFunction_1.return)) _a.call(funcsInFunction_1);
                }
                finally { if (e_1) throw e_1.error; }
            }
        ...
        addEquality(utils_1.isFunction, function (n) { return n; }, type(function (node) {
            ...
            nodesInFunction.filter(function (n) { return ts.isIdentifier(n); })
                ...
                if (identDecl && (0, utils_1.isFunction)(identDecl) && !(0, utils_1.isUnder)(node, identDecl)) {
                    ...
                    try {
                        for (var _b = __values(identDeclType.closureParams), _c = _b.next(); !_c.done; _c = _b.next()) {
                            var param = _c.value;
                            _loop_5(param);
                        }
                    }
                    ...
                    var identDeclFunc = identDecl && (0, utils_1.findParentFunction)(identDecl);
                    var isFieldName = ts.isPropertyAccessExpression(ident.parent) && ident.parent.name === ident;
                    var assigned = (0, utils_1.isEqualsExpression)(ident.parent) || (0, utils_1.isCompoundAssignment)(ident.parent);
                    if (identDeclFunc && identDeclFunc != node && (0, utils_1.isUnder)(identDeclFunc, node) && !isFieldName) {
        ...
        addEquality(ts.isReturnStatement, function (n) { return n.expression; }, type(function (n) { return ctypes_1.FuncType.getReturnType(_this.typeHelper, (0, utils_1.findParentFunction)(n)); }));
        addEquality(ts.isReturnStatement, function (n) { return (0, utils_1.findParentFunction)(n); }, type(function (n) { return _this.typeHelper.getCType(n.expression) ? new ctypes_1.FuncType({ returnType: _this.typeHelper.getCType(n.expression) }) : null; }));
    ...
    TypeResolver.prototype.resolveTypes = function (typeEqualities) {
        ...
        do {
            changed = false;
            try {
                for (var equalities_1 = (e_4 = void 0, __values(equalities)), equalities_1_1 = equalities_1.next(); !equalities_1_1.done; equalities_1_1 = equalities_1.next()) {
                    var equality = equalities_1_1.value;
                    var _b = __read(equality, 2), node = _b[0], _c = __read(_b[1], 3), _ = _c[0], node1_func = _c[1], node2_resolver = _c[2];
                    ...
                    if (!node2 && !type2)
                        continue;
                    var _d = this.typeMerger.mergeTypes(type1, type2), type = _d.type, replaced = _d.replaced;
                    if (type && replaced) {
                        if (type != type1)
                            changed = true;
                        if (node2 && type != type2)
                ...
                try {
                    if (equalities_1_1 && !equalities_1_1.done && (_a = equalities_1.return)) _a.call(equalities_1);
                }
                finally { if (e_4) throw e_4.error; }
            }
        } while (changed);
...
var TypeHelper = /** @class */ (function () {
    ...
    TypeHelper.prototype.convertType = function (tsType, node) {
        ...
        if (tsType.flags & ts.TypeFlags.Object && tsType.getProperties().length > 0 && tsType.getProperties().every(function (s) { return /[a-zA-Z_]/.test(s.name); })) {
            ...
            structType.forcedType = cTypeTag && cTypeTag.text.map(function (t) { return t.text; }).join().trim();
            structType.external = baseType && baseType.symbol && (0, utils_1.findParentSourceFile)(baseType.symbol.declarations[0]).isDeclarationFile;
            return structType;
        }
        return null;
    };
    TypeHelper.prototype.generateStructure = function (tsType) {
        ...
        var userStructInfo = {};
        try {
            for (var _b = __values(tsType.getProperties()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var prop = _c.value;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SyntaxKind_NaNKeyword = void 0;
...
function getAllFunctionNodesInFunction(node) {
    var nodes = __spreadArray([], __read(node.getChildren()), false);
    var foundFuncNodes = [];
    var cur;
...
function transpile(source) {
    ...
    var compilerHost = {
        getSourceFile: function (fileName, target) { return fileName === 'source.ts' ? sourceFile : null; },
